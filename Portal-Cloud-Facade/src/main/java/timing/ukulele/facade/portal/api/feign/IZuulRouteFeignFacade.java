...
import timing.ukulele.facade.portal.api.IZuulRouteFacade;
import timing.ukulele.facade.portal.model.persistent.SysZuulRoute;

import java.util.Map;

@FeignClient(name = "portal-service", fallback = IZuulRouteFeignFacade.ZuulRouteHystrixClientFallback.class)
public interface IZuulRouteFeignFacade extends IZuulRouteFacade {
    class ZuulRouteHystrixClientFallback implements IZuulRouteFeignFacade {
